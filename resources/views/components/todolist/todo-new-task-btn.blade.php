<div
    {{ $attributes->merge(['class' => 'w-14 h-14 bg-gray-700 rounded-full shadow ring ring-green-500 ring-offset-4 ring-offset-gray-900 border border-transparent hover:border-2 hover:border-green-500 hover:ring-0 hover:ring-offset-0 hover:ring-offset-gray-900 ease-in-out duration-300']) }}>
