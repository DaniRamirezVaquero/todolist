@props(['id' => 'id', 'route' => 'route' , 'message' => 'message'])

<div id="{{$id}}"
    {{ $attributes->merge(['class' => 'active:ring ease-in duration-150 w-9 h-9 rounded bg-red-500 flex justify-center items-center border border-red-500 hover:bg-red-500/25']) }}>
...
<x-todolist.todo-confirm-span id="{{$id}}" route="{{$route}}" message="{{$message}}"/>
