<div {{ $attributes->merge(['class' => 'w-14 h-14 bg-gray-700 rounded-full shadow flex justify-center items-center ring-0 ring-transparent hover:ring-zinc-300 hover:ring ease-in-out duration-300']) }}>
    <a href="{{route('config')}}" class="flex items-center
